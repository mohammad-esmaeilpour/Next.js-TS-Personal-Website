...
export const aboutData = {
  career: {
    ...
    description:
      "My career began in [Year/Industry], and over the years, Ive had the privilege of working with [Companies/Clients]. Heres a snapshot of my journey:",
    positionCard: [
      {
        title: "- **[Position] at [Company]** (Year - Year)",
  ...
  achievements: {
    ...
    subTitle:
      "Over the years, Ive had the opportunity to work on some exciting projects, such as:",
  },
  interests: {
