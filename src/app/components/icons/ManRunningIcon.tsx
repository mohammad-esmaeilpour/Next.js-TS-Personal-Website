...
const ManRunningIcon = ({ size }: IconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 128 128">
      ...
      />
      <ellipse cx="52.17" cy="21.9" fill="#404040" rx="1.76" ry="1.14" transform="rotate(-87.799 52.17 21.9)" />
      <path
        fill="#6d4c41"
      ...
      <path
        fill="url(#notoPersonRunning9)"
        d="M73.06 18.58c.05-.09-.82 1.99-4.42 1.58c-1.48-.03-3.61 3.51-1.49 5.91c1.88 2.12 4.74.92 4.74.92s-.39.11-.96-.1c-.37-.14-.49-.62-.49-.64c-.13-.53.37-1.24 1.27-2.01c2.58-2.24 1.71-4.85 1.35-5.66"
      />
      <radialGradient
        id="notoPersonRunninga"
        cx="-2446.895"
        cy="347.088"
        r="7.226"
      ...
      <path
        fill="url(#notoPersonRunninga)"
        d="M73.59 12.82c-.66-1.76-1.91-3.25-3.57-4.13c-.24-.13-.83-.43-1.24-.51c.18.78.15 1.61-.2 2.45c-.01.03-.41 1.29-1.52 2.29c.77 1.11 1.15 2.45 1.5 3.77c.31 1.15.6 2.41.08 3.48c.69-.03 1.79.18 3.01-.34c1.17-.5 1.8-1.83 2.11-3.02c.33-1.32.31-2.71-.17-3.99"
      />
      <radialGradient
        id="notoPersonRunningb"
        cx="-2454.956"
        cy="349.582"
        r="14.873"
      ...
      <path
        fill="url(#notoPersonRunningb)"
        d="M68.57 10.63c.91-2.22-.28-4.3-2.11-5.71c-2.15-1.65-5.01-1.83-7.6-1.45c-1.84.27-3.19 1.12-4.39 1.87c-.51.32-1 .63-1.45.83c-.37.17-1.02.32-1.55.13c-1.21-.42-.78-2.25-.78-2.25s-4.46.8-2.62 5.13c-1.5.63-2.22 2.2-2.51 3.68c-.4 2.02.56 3.98 2.49 4.88c0 0-.33-3.27 4.38-2.99c1.46.09 2.98.34 4.35-.18c1.21-.46 1.63-1.1 2.97-1c1.45.11 3.37.69 4.86.49c3.02-.41 3.95-3.39 3.96-3.43"
      />
      <radialGradient
        id="notoPersonRunningc"
        cx="-2446.095"
        cy="339.029"
        r="8.007"
      ...
      <path
        fill="url(#notoPersonRunningc)"
        d="M67.15 26.07c-.95-1.05-1.18-2.75-2.68-3.69c-.3.98-1.03 1.91-2.16 2.26c-.26.08.27 4.51 5.73 4.61c2.82.05 3.86-2.27 3.86-2.27s-2.83 1.2-4.75-.91"
      />
    </svg>
  );
};

export default ManRunningIcon;
